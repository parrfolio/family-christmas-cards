...
(function($){
	$.fn.snowfall = function(options){
		...
		function Flake(_x, _y, _size, _speed)
		{
			...
			var flakeMarkup = "<div class='flake' id='flake-" + this.id + "' style='width: " + this.size + "px; height: " + this.size + "px; background: transparent url(merrychristmas/images/flakes-"+ this.id +".png) no-repeat; position: absolute; top: " + this.y + "px; left:" + this.x + "px; z-index: " + options.flakeIndex + ";'></div>";
